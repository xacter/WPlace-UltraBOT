  ...
  > [!NOTE]
  > **大家好，在新措施推出之后，我决定开发这个机器人，并且只用了一天就完成了。由于这些措施，目前似乎不可能制作出一个完全自动化的机器人。不过，得益于一个现有的漏洞，我们现在可以在一次验证后，用 12 个账号在 1 秒内进行绘制。假设这些账号的点数都是满的，那么我们每秒可以发送 12 * 62 = <strong>744</strong> 个像素。如果你已经准备好了，下面我会说明如何使用它。**
